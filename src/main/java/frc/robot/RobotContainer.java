...
import frc.robot.commands.BlinkOnboardLED;
import frc.robot.commands.WaveArm;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_onboardIO.setDefaultCommand(new BlinkOnboardLED(m_onboardIO));
    m_arm.setDefaultCommand(new WaveArm(m_arm));
